  ...
  #+begin_src emacs-lisp :tangle init.el
    (use-package go-mode :mode "\\.go\\'"
      ...
      :hook ((go-mode . eglot-ensure)
             ...
             (go-mode . (lambda () (add-hook 'project-find-functions #'project-find-go-module -90 t)))
...
** Haskell
   ...
   #+begin_src emacs-lisp :tangle init.el
     ;; Haskell defines a package (or project in Eglot lingo) to be a
     ;; directory that contains a cabal file.
     (require 'project)
     ...
     (defun project-find-haskell-package (dir)
       (when-let ((root (locate-dominating-file dir #'find-cabal-file)))
         (cons 'haskell-package root)))

     (cl-defmethod project-root ((project (head haskell-package)))
       (cdr project))
   #+end_src
   ...
   #+begin_src emacs-lisp :tangle init.el
     (use-package haskell-mode
       ...
       :hook ((haskell-mode . interactive-haskell-mode)
              ...
              (haskell-mode . (lambda () (add-hook 'project-find-functions #'project-find-haskell-package -10 t)))
              (haskell-mode . (lambda () (eglot-ensure))))
