...
** Tree-Sitter
   ...
   #+begin_src emacs-lisp :tangle init.el
     ...
     (defun local/install-treesit-language-if-missing (lang)
     ...
     (mapc #'local/install-treesit-language-if-missing (mapcar #'car treesit-language-source-alist))
   #+end_src
...
** Rust
  ...
  #+begin_src emacs-lisp :tangle init.el
    ...
    (use-package rustic :straight t :config
  ...
  #+begin_src emacs-lisp :tangle init.el
    (use-package cargo-mode :straight t)
  #+end_src
...
** Golang
  ...
  #+begin_src emacs-lisp :tangle init.el
    (use-package go-mode :mode "\\.go\\'" :after eglot :defer t :straight t
...
* Counsel / Ivy
 ...
 #+begin_src emacs-lisp :tangle init.el
   ...
   (use-package swiper :straight t :bind ("M-s o" . swiper))
