...
** Rust
  ...
  #+begin_src emacs-lisp :tangle init.el
    (use-package rustic :mode ("\\.rs\\'" . rustic-mode) :defer nil
      :hook (rustic-mode . eglot-ensure)
      :custom
      ;; disable default LSP setup, it does not allow us to specify clippy
...
** Visual appearance
   ...
   on the time of day (actually where the sun is).

   #+begin_src emacs-lisp :tangle init.el
     (use-package circadian :defer nil
       :config
       (setq calendar-latitude 57.7089
     	calendar-longitude 11.9746
